...
import { firestore } from '../../backend/firebaseConfig'; // Ensure the correct path to firebaseConfig
      ...
      <div className="lg:w-2/3 p-6">
        {selectedBooking ? (
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
            <h2 className="text-2xl font-bold text-gray-800">Select a Booking to See Details</h2>
          </div>
        )}
      </div>
    </div>
